...
import com.androtechbuddy.tkiet.webActivity;
import com.androtechbuddy.tkiet.DeviceInfo;
...
public class Tools {
    ...
    public static DeviceInfo getDeviceInfo(Context context) {
        ...
        deviceInfo.device = com.androtechbuddy.tkiet.Tools.getDeviceName();
        deviceInfo.os_version = com.androtechbuddy.tkiet.Tools.getAndroidVersion();
        deviceInfo.app_version = com.androtechbuddy.tkiet.Tools.getVersionCode(context) + " (" + com.androtechbuddy.tkiet.Tools.getVersionNamePlain(context) + ")";
        deviceInfo.serial = com.androtechbuddy.tkiet.Tools.getDeviceID(context);
        return deviceInfo;
    }
    ...
    public static void openInAppBrowser(Activity activity, String url, boolean from_notif) {
        ...
        webActivity.navigate(activity, url, from_notif);
    }
